...
try:
    ...
    logger.warning(f"ElevenLabs not installed: {e}. Install with: pip install elevenlabs")
...
class TTSService:
    ...
    def _init_elevenlabs(self):
        ...
        try:
            ...
            logger.error(f"Failed to initialize ElevenLabs: {e}, falling back to pyttsx3")
            self.provider = "pyttsx3"
            self._init_pyttsx3()
    ...
    def preview_voice(self, voice_id: str, text: str = "Hello! This is a voice preview.") -> bool:
        """
    ...
    def stop_current_audio(self) -> None:
        ...
        if self._current_process and self._current_process.poll() is None:
            try:
                ...
                self._current_process.wait(timeout=0.5)  # Wait briefly for clean termination
    ...
    def cancel_all(self) -> int:
        ...
        logger.info(f"Cancelled all TTS: stopped audio and cleared {cleared} queued messages")
        return cleared
